...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(269, 32);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(257, 37);
			this->label3->TabIndex = 7;
			this->label3->Text = L"Nos Commandes";
			// 
			// RETOUR
			// 
			...
			this->RETOUR->Click += gcnew System::EventHandler(this, &Commande1::RETOUR_Click);
			// 
			// listBox1
			// 
